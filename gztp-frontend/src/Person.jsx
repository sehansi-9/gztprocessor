...
const sampleTransactions = {
    moves: [
        {
            type: "MOVE",
            name: "Hon. Thalatha Atukorale",
            from_ministry: "Ministry of Justice and Prison Reforms",
            from_position: "Minister",
            to_ministry: "Ministry of Justice",
            to_position: "Minister",
            date: "2018-07-15",
        },
    ],
    adds: [
        {
            type: "ADD",
            new_person: "Hon. Kabir Hashim",
            new_ministry: "Ministry of Roads and Highways",
            new_position: "Minister",
            date: "2018-07-15",
            suggested_terminates: [
                {
                    existing_person: "Hon. Kabir Hashim",
                    existing_ministry: "Ministry of Highways and Road Development",
                    existing_position: "Deputy Minister",
                    score: 75.0,
                    mark: false,
                },
            ],
